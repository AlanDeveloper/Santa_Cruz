...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="/medic" class="row g-3 needs-validation" novalidate>
                        {{  csrf_field() }}
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="speciality" class="form-control" id="validationCustom08" placeholder="Preencha com sua especialiade" required>
                            <div class="invalid-feedback">
                                É necessário preencher o campo corretamente!
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="crm" class="form-control" id="validationCustom07" placeholder="Preencha com seu CRM" required>
                            <div class="invalid-feedback">
                                É necessário preencher o campo corretamente!
                            </div>
                        </div>
    ...
    @if ($errors->any())
        <div class="alert alert-danger">Houve um erro ao cadastrar o médico!</div>
    @endif
