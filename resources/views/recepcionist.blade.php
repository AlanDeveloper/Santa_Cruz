        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="/recepcionist" class="row g-3 needs-validation" novalidate>
                        {{  csrf_field() }}
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="knowledge" class="form-control" id="validationCustom06" placeholder="" required>
                            <div class="invalid-feedback">
                                É necessário preencher o campo corretamente!
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="experience" class="form-control" id="validationCustom07" placeholder="" required>
                            <div class="invalid-feedback">
                                É necessário preencher o campo corretamente!
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <label for="validationCustom08" class="form-label">Endereço</label>
                            <input type="text" name="address" class="form-control" id="validationCustom08" placeholder="Preencha com seu endereço" required>
                            <div class="invalid-feedback">
                                É necessário preencher o campo corretamente!
                            </div>
                        </div>
